...
def main():
    ...
    # ============================================================
    print(f"\n{'=' * 65}")
    print(f"  RUNNING ASNPE")
    print(f"  Started: {time.strftime('%Y-%m-%d %H:%M:%S')}")
    print(f"  Note: Sampling between rounds may be slow due to low acceptance rates")
    print(f"  A progress message will appear every 30 seconds")
    print(f"{'=' * 65}\n")
    ...
    # Monitor thread to show progress
    ...
    def progress_monitor():
        ...
        while not stop_monitor.is_set():
            time.sleep(30)
            print(f"  [MONITOR] Still running... (round {round_num})")
